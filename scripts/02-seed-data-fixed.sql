-- Заполнение тестовыми данными (исправленная версия)
...
DO $$
DECLARE
    vip_zone_uuid UUID := '660e8400-e29b-41d4-a716-446655440001';
    row_num INTEGER;
    seat_num INTEGER;
BEGIN
...
DO $$
DECLARE
    parter_zone_uuid UUID := '660e8400-e29b-41d4-a716-446655440002';
    row_num INTEGER;
    seat_num INTEGER;
BEGIN
...
DECLARE
    ...
    current_zone_uuid UUID;
    row_num INTEGER;
    seat_num INTEGER;
    y_offset INTEGER;
BEGIN
    FOR i IN 1..array_length(balcony_zones, 1) LOOP
        current_zone_uuid := balcony_zones[i];
